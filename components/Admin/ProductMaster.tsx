                            ...
                            <thead>
                              <tr className="bg-slate-50 border-b border-slate-200">
                                ...
                                {rangeSizes.map((size) => (
                                  <th
                                    key={size}
                                    className="px-2 py-3 text-[10px] font-bold text-emerald-600 uppercase tracking-wider text-center whitespace-nowrap min-w-[60px]"
                                  >
                                    {size}
                                  </th>
                                ))}
                              ...
                              {rangeVariants.map((variant, idx) => (
                                ...
                                >
                                  ...
                                  <td className="px-4 py-2.5">
                                    <input
                                      type="text"
                                      className="w-full min-w-[160px] p-2 bg-transparent border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 outline-none focus:ring-1 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all placeholder:text-slate-300"
                                  ...
                                  <td className="px-3 py-2.5">
                                    <input
                                      type="text"
                                      placeholder="Auto"
                                      className="w-full min-w-[90px] p-2 bg-transparent border border-slate-200 rounded-lg text-xs text-slate-500 outline-none focus:ring-1 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all"
                                      value={variant.sku}
                                      onChange={(e) =>
                                        updateVariantField(
                                          variant.id,
                                  ...
                                  <td className="px-3 py-2.5">
                                    <input
                                      type="number"
                                      placeholder="0"
                                      className="w-full min-w-[90px] p-2 bg-transparent border border-slate-200 rounded-lg text-xs font-bold text-slate-700 outline-none focus:ring-1 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all"
                                  ...
                                  {rangeSizes.map((size) => (
                                    ...
                                    >
                                      <input
                                        ...
                                        min="0"
                                        placeholder="0"
                                        className="w-full min-w-[50px] p-2 bg-emerald-50/50 border border-emerald-200/50 rounded-lg text-xs font-bold text-emerald-800 text-center outline-none focus:ring-1 focus:ring-emerald-400/30 focus:border-emerald-400 transition-all"
                                        value={
